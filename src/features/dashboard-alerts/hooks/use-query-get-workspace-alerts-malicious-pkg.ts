...
import { isAlertConversationMalicious } from "../../dashboard-messages/lib/is-alert-malicious";
...
function select(data: V1GetWorkspaceAlertsResponse) {
  return multiFilter(data, [isAlertCritical, isAlertConversationMalicious]);
}
